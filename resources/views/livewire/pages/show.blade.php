...
<div class="md:py-10 md:px-24 flex md:flex-row flex-col md:space-x-5 space-y-5 w-full">
    <div class="md:w-3/5 w-full mt-5 space-y-2">
        <div class="flex justify-between md:px-0 px-2">
            <div class="w-full">
                <p class="text-2xl font-bolder truncate-text w-full">{{ $page->title }}</p>
                <p class="text-sm text-gray-500 truncate-text w-full">{{ $page->slug }}</p>
            </div>
        </div>

        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4 border border-gray-200 p-6 rounded-lg">
